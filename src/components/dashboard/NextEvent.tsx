  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-3 flex w-full items-start gap-3 rounded-xl bg-gray-50 p-3 text-left transition-colors hover:bg-gray-100 dark:bg-slate-800 dark:hover:bg-slate-700"
