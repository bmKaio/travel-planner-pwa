...
function SettingsSection() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      ...
      <div className="space-y-3 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          La exportación incluye toda la base de datos en formato JSON. La importación reemplaza los
          datos actuales.
        </p>
      </div>
